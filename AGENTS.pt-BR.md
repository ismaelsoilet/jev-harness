...
4. 🛡️ **[Testes Exaustivos e Honestidade Absoluta](.agents/rules/04_testing_and_truthfulness.md)**: Postura de zero-trust, proibição de testes tautológicos, bateria de 197 testes.
...
[Alteração de Código ou Docs]
        │
        ▼
[1. Executar 197 Testes: ./scripts/release.sh --check]
        │ (Se 100% OK)
        ▼
