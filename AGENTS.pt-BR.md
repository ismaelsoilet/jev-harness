...
> 
> *Versão do Projeto: v0.1.11 — Sincronizado nos 4 registries oficiais.*
...
4. 🛡️ **[Testes Exaustivos e Honestidade Absoluta](.agents/rules/04_testing_and_truthfulness.md)**: Postura de zero-trust, proibição de testes tautológicos, bateria de 184 testes.
...
[Alteração de Código ou Docs]
        │
        ▼
[1. Executar 184 Testes: ./scripts/release.sh --check]
        │ (Se 100% OK)
        ▼
