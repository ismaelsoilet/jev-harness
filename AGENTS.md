...
> 
> *Project Version: v0.1.13 — Synchronized across all 4 official registries.*
...
4. 🛡️ **[Exhaustive Testing & Absolute Truthfulness](.agents/rules/04_testing_and_truthfulness.md)**: Zero-trust posture, prohibition of tautological tests, 210-test battery.
...
[Code or Docs Modification]
        │
        ▼
[1. Run 210 Tests: ./scripts/release.sh --check]
        │ (If 100% Passing)
        ▼
