...
## 3. Bateria Oficial Tri-Runtime (211 Testes)

O repositório mantém **211 testes exaustivos** com 100% de taxa de aprovação através dos três runtimes:
...
2. **Rust (`packages/rust/tests/`)**: **49 testes**
...
3. **TypeScript (`packages/ts/tests/`)**: **45 testes**
...
* **Nunca esconda regressões**: Se uma alteração causou a quebra de um único teste dos 211, pare imediatamente, não faça commit e investigue a causa raiz.
