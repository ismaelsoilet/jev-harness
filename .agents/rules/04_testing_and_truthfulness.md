...
## 3. Bateria Oficial Tri-Runtime (184 Testes)

O repositório mantém **184 testes exaustivos** com 100% de taxa de aprovação através dos três runtimes:
...
2. **Rust (`packages/rust/tests/`)**: **43 testes**
...
3. **TypeScript (`packages/ts/tests/`)**: **39 testes**
...
* **Nunca esconda regressões**: Se uma alteração causou a quebra de um único teste dos 184, pare imediatamente, não faça commit e investigue a causa raiz.
